...
function ENT:Draw()
    ...
    cam.Start3D2D(self:GetPos() + self:GetUp() * (80 + self.LeviationOffset), Angle(0, LocalPlayer():EyeAngles().y - 90, 90), 0.2)
        draw.SimpleText("Livraison", DELIVERY:Font(40), 0, rectPosY + rectHeight / 2 - barHeight / 2, NPC_ARMORY.Config.ColorTextAboveNPC, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
    cam.End3D2D()      
